...
<p><?php esc_html_e('Now go to Settings > Reading > Your homepage displays > A static page (select below) and set that page as your homepage.','real-estate-elementor'); ?> </p>
    ...
    <p>
        <a target="_blank" href="https:/https://testerwp.com/docs/real-estate-elementor-pro/" class="button button-primary"><?php esc_html_e('Theme Documentation','real-estate-elementor'); ?></a>
    </p>
</div>
  ...
  <div class="theme_link">
    ...
    <div class="card-content">
        <div class="columns">
                    ...
                    <a href="https://testerwp.com/lp/real-estate-elementor-pro-preview/" target="_blank" class="button button-primary"><?php esc_html_e("Check Pro","real-estate-elementor"); ?></a>
                    <hr>
